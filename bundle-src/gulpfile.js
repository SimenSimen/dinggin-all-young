...
const jsFiles = [
   './src/external/jquery/jquery.min.js',
   ...
   './src/external/instafeed/instafeed.min.js',
   ...
   './src/external/bootstrap-datepicker/bootstrap-datepicker.js',
...
gulp.task('build', gulp.series(clean, gulp.parallel(styles,favicon,external,font_icons,video,sound,scss,ajaxContent,img,scripts,html)));
