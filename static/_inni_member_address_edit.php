...
<div class="tt-breadcrumb">
	<div class="container">
		<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			...
			<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
				<a itemprop="item" href="_inni_member_address.php">
                    <span itemprop="name">Common Shipping Address</span>
                </a>
			<meta itemprop="position" content="3">
			</li>
			<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
				<a itemprop="item" href="_inni_member_address_edit.php">
                    <span itemprop="name">Modify common shipping address</span>
                </a>
				...
				<div class="container openside pall0">
		            ...
		            <form action="" class="" method="post" onsubmit="")>
						<section class="content has-side">
							<div class="title">Modify common shipping address</div>
							<div class="editor mg">
								<div class="form-box">									
			                        <div class="form-group">
			                            <div class="control-box">
			                                ...
			                                <input class="form-control" type="text" name="name" id="" value="joy">
			                            </div>
			                        </div>			                        
			                        <div class="form-group">
			                            <div class="control-box">
			                                ...
			                                <input class="form-control" type="text" maxlength="10" name="mobile" id="" value="0987654321">
			                            </div>
			                        </div>

									<p><span>*</span>Mailing Address</p>
                        
						            <div class="form-group">
			                            <div class="control-box">
			                            	<i name="icon02" class="icon-placeholder"></i>
			                            	<label class="control-label ml-2 mt-1">Address</label>
			                                <input class="form-control" type="text" name="address" id="" value="8th Floor, No.4, Lane 609, Section 5, Zhongwei Road">
			                            </div>
			                        </div>	                        
			                        <div class="form-group">
			                            <div class="control-box">
			                        ...
			                        <div class="form-group">
			                            <div class="control-box">
			                            	<i name="icon02" class="icon-placeholder"></i>
			                            	<label class="control-label ml-2 mt-1">Postcode</label>
			                                <input class="form-control" type="text" name="buyer_postcode" id="buyer_postcode" value="241">
			                            </div>
			                        </div>
