...
<div class="tt-breadcrumb">
	<div class="container">
		<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			...
			<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
				<a itemprop="item" href="_inni_member_management.php">
                    <span itemprop="name">Upgrade Management Member</span>
                </a>
									 ...
									 <div class="managemenbox">
			                        	...
			                        	<div class="form-group name">
											...
											<div class="control-box">
												<div class="radio-box">
													<label class="form-radio checked"><input type="radio" name="gender" id="" checked=""> General</label>
													<label class="form-radio"><input type="radio" name="gender" id=""> Legal Person</label>
												</div>
											</div>
										</div>
				                        ...
				                        <div class="form-group">
				                            <div class="control-box">
				                                ...
				                                <input class="form-control w200" type="text" maxlength="10" name="id-number" id="" value="">
				                            </div>
				                        </div>
			                        </div>
			                        ...
			                        <div class="managemenbox">
				                        ...
				                        <div class="form-group">
				                            <div class="control-box">
				                                ...
				                                <input class="form-control w200" type="text" name="bank" id="" value="">
				                            </div>
				                        </div>
				                        ...
				                        <div class="form-group">
				                            <div class="control-box">
				                                ...
				                                <input class="form-control w200" type="text" name="branch" id="" value="">
				                            </div>
				                        </div>
				                        ...
				                        <div class="form-group">
				                            <div class="control-box">
				                                ...
				                                <input class="form-control w200" type="text" name="accountTit" id="" value="">
				                            </div>
				                        </div>
				                        ...
				                        <div class="form-group">
				                            <div class="control-box">
				                                ...
				                                <input class="form-control w200" type="text" name="bankAccount" id="" value="">
				                            </div>
				                        </div>
											...
											<div class="control-box">
												<div class="radio-box">
													<label class="form-radio checked">
														<input type="radio" name="gender" id="" checked=""> General
													</label>
													<label class="form-radio">
														<input type="radio" name="gender" id=""> Legal Person
													</label>
												</div>
											</div>
										</div>
										...
										<div class="managemenbox">
					                        <div class="form-group">
					                        	<div class="control-box">
				                                    <div class="radio-box">
				                                    	<label class="form-radio checked">
															<input type="radio" name="tax" id="" value="tax-free"> Tax-Free Card
														</label>
														<label class="form-radio" style="margin-left:20px;">
															<input type="radio" name="tax" id="" value="tax"> Tax Card
														</label>	
				                                    </div>
				                                </div>											
												<div class="control-box">
