...
<div class="tt-breadcrumb">
	<div class="container">
		<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			...
			<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
				<a itemprop="item" href="_inni_member_announcement.php">
                    <span itemprop="name">Member Announcement</span>
                </a>
					...
					<section class="content has-side">
						<div class="wrapper">
							<div class="announcementbox">
							    <ul>
							        <li class="c_green02H">
							          <a href="_inni_service.php">Member Terms of Service</a>
							        </li>
							      	<li class="c_green02H">
							          <a href="_inni_privacy.php">Privacy policy</a>
							        </li>
							        <li class="c_green02H">
							          <a href="_inni_announcement.php">Member benefits</a>
							        </li>
							    </ul>
							</div>     
						</div>         
