...
<head>
  ...
  <!-- seo -->
  <title>分類標題設定 - <?=$web_config['title']?></title>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="personal-info">
        <tr>
          <td class="step-info-01">
            ...
            <legend align="right">&nbsp;分類標題設定&nbsp;<input style="font-size: 17px; padding: 5px 10px 5px 10px; margin: 0px;" class="aa3" type='submit' name='form_submit' value='儲存編輯'>&nbsp;</legend>
