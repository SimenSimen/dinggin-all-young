  ...
  <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain">
    ...
    <table id='share_btn_table'>
      <tr>
          ...
          <td>
              <a href="http://line.naver.jp/R/msg/text/?<?=$header_title?>%0D%0A<?=$actual_link?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
          </td>
          <td>
              <!-- Email -->
              <a href="mailto:?subject=<?=$header_title?>&body=<?=$header_title?>網址：<br><?=$actual_link?>">
