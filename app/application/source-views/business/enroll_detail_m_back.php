...
<? }//if ($istemplate8 || $allopen){?>
	...
	<div data-role="header" class="ui-header ui-bar-b" data-theme="b" role="banner">
		<?php if (!$v): ?><a href="<?=$iqr_url?>" data-icon="arrow-l" class="ui-btn-left ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-left ui-btn-up-a" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-theme="a"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text"><i class="fa fa-arrow-left"></i></span><span class="ui-icon ui-icon-arrow-l ui-icon-shadow">&nbsp;</span></span></a><?php endif; ?>
