...
<head>
  ...
  <!-- seo -->
  <title>QRcode - <?=$web_config['title']?></title>
...
<div data-role="page" class="type-interior ui-page ui-body-c ui-page-active" id="page1">
  ...
  <div data-role="header" class="ui-header ui-bar-b" data-theme="b" role="banner">
    <a href="<?=$iqr_url?>" data-icon="arrow-l" class="ui-btn-left ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-left ui-btn-up-a" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-theme="a"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text"><i class="fa fa-arrow-left"></i></span><span class="ui-icon ui-icon-arrow-l ui-icon-shadow">&nbsp;</span></span></a>
    <h1>行動商務系統</h1>
  </div>
  ...
  <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain">
    ...
    <table id='share_btn_table'>
      <tr>
          ...
          <td>
              <a href="http://line.naver.jp/R/msg/text/?<?=$share_title?> <?=$share_link?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
          </td>
          <td>
              <!-- Email -->
  ...
  <?php endif; ?>
    ...
    <p style="font-family:'微軟正黑體';">※ 提醒您，若您的嵌入圖片沒有出現，請嘗試重新整理網頁(註：瀏覽器版本過舊將不支援圖片顯示)</p>
    <button style="width:85%;height:62.8px;text-shadow:none; background:#333" name="iqr_url" id="text"><span style="text-shadow:none; color: white;">※ 您也可以點此直接下載</span></button>
</div>
