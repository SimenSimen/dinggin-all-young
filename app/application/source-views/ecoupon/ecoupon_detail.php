...
<!--						
                        <div class="bzm-content" id="modal2" data-title="分享到">   
                            <ul class="share-box">
							        <!-- fb --><!--
                              <li><a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"><i><img src="/template/temp3/images/icon-fb.png" align="center" ></i>facebook</a></li>
                              <li><a href="http://line.naver.jp/R/msg/text/?<?=$iqr_name?>行動商務系統 <?=$iqr_url?>"><i><img src="/template/temp3/images/icon-line.png" align="center" ></i>LINE</a></li>
                              <li><a href="http://www.jiathis.com/share"><i><img src="/template/temp3/images/icon-wechat.png" align="center"></i>WeChat</a></li>
                            </ul>
                        </div>
-->						
