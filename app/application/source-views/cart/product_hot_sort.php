...
<div id="container"><div style="margin:0px auto; width: 1500px;">
 
  <p style="font-size:20px;">購物車熱銷品排序
    <a href="#" class="why">?</a>
    <a href='/cart/cart_management' target='_top' class="aa5" style="font-size:20px; margin-left: 0px; padding: 9px 10px;">返回商品管理 <i class="fa fa-reply"></i></a>&nbsp;
  ...
  <p style="width: 100%; text-align: right; border-radius: 5px; margin-left: 4px; vertical-align: middle;">
    <span style="padding: 15px 20px 15px 20px;" class="aa6">熱銷品筆數 (<?=$hot_num?>)</span>
