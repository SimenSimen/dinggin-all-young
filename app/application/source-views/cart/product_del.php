...
<head>
  ...
  <!-- seo -->
  <title><?=$Deleteitem?> - <?=$web_config['title']?></title>
...
<div id="container"><div class="w1024">
  ...
  <p style="font-size:20px;"><?=$ShoppingCartDitem?>
    <a href="#" class="why">?</a>
    <a href='/cart/cart_management' target='_top' class="aa5" style="font-size:20px; margin-left: 0px; padding: 9px 10px;"><?=$Returns?> <i class="fa fa-reply"></i></a>&nbsp;
    <div class='prompt-box'>
      <p><?=$Remove_check_goods?></p>
    </div>
  </p>
  <br>
  
  <!--主介面區-->
  <form action='/cart/product_del' method='post' name='form_product_del' id='form_product_del'>
...
<script type="text/javascript" src="/js/product_del.js"></script>
