        ...
        <form id='upload_data' method='post'  enctype="multipart/form-data">
            ...
            <tr>
              ...
              <?php if($shelf['shelf_capture_url1']): ?>
                <td>
                  ...
                  <input style="position: absolute;margin: 55px 0px 0px 30px; font-family: Microsoft JhengHei;padding: 1px 7px 1px 7px" type="submit" name="del_mobile1" id="del_mobile1" value="刪除">
                </td>
              <?php else: ?>
            ...
            <tr>
              ...
              <?php if($shelf['shelf_capture_url2']): ?>
                <td>
                  ...
                  <input style="position: absolute;margin: 55px 0px 0px 30px; font-family: Microsoft JhengHei;padding: 1px 7px 1px 7px" type="submit" name="del_mobile2" id="del_mobile2" value="刪除">
                </td>
              <?php else: ?>
            ...
            <tr>
              ...
              <?php if($shelf['shelf_capture_url3']): ?>
                <td>
                  ...
                  <input style="position: absolute;margin: 55px 0px 0px 30px; font-family: Microsoft JhengHei;padding: 1px 7px 1px 7px" type="submit" name="del_mobile3" id="del_mobile3" value="刪除">
                </td>
              <?php else: ?>
            ...
            <tr>
              ...
              <?php if($shelf['shelf_capture_url4']): ?>
                <td>
                  ...
                  <input style="position: absolute;margin: 55px 0px 0px 30px; font-family: Microsoft JhengHei;padding: 1px 7px 1px 7px" type="submit" name="del_mobile4" id="del_mobile4" value="刪除">
                </td>
              <?php else: ?>
            ...
            <tr>
              ...
              <?php if($shelf['shelf_capture_url5']): ?>
                <td>
                  ...
                  <input style="position: absolute;margin: 55px 0px 0px 30px; font-family: Microsoft JhengHei;padding: 1px 7px 1px 7px" type="submit" name="del_mobile5" id="del_mobile5" value="刪除">
                </td>
              <?php else: ?>
            ...
            <tr>
              <td style="text-align: center;" colspan="4">
                  <input class='aa3' style='font-size: 1.2em; margin: 20px 5px;padding: 9px 29px 9px 29px;' id='save_data' type='submit' name='save_data' value='儲存'>
                  ...
                  <?php elseif(!$shelf['shelf_brief'] || !$shelf['shelf_description'] || !$shelf['shelf_capture_url1'] || !$shelf['shelf_capture_url2'] || !$shelf['shelf_capture_url3'] || !$shelf['shelf_capture_url4'] || !$shelf['shelf_capture_url5'] || !$shelf['shelf_HD_url'] || !$shelf['shelf_topic_url'] || $shelf['type'] == '0' || $shelf['type'] == NULL): ?>
                    <input class='aa3lock' style='font-size: 1.2em; margin: 20px 5px;padding: 9px 29px 9px 29px;' id='upload' type='submit' name='upload' value='請先進行儲存，再上傳' onclick="return check_form();" title="須填完以上資料" >
                  <?php elseif($iqr['apk'] == 2 || $iqr['apk'] == 0 || $icon_size ):?>
                    <input class='aa3lock' style='font-size: 1.2em; margin: 20px 5px;padding: 9px 29px 9px 29px;' id='upload' type='submit' name='upload' value='請將APP資料更新，再上傳' onclick="return check_form();" title="至自動打包更新您的APP" >
                  <?php endif; ?>
              </td>
          </table>
          </form>
