...
class Index extends MY_Controller
{
	...
	/**
	 * products files path preifx
	 *
	 * @var string
	 */
	public $productPath = '/uploads/000/000/0000/0000000000/products/';
	...
	public function index()
	{
		...
		$data['banners']  = $this->banner_model->getMyAd();

		$this->load->model('products_model', 'productsModel');;
		$this->load->model('product_class_model', 'productsClassModel');;
