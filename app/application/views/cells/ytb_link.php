        ...
        case 1: ?>
            ...
            <?php if ($ytb_link_num != 0): ?>
                <?php foreach ($ytb_link as $key => $value): ?>
                    <p class='user_text'>
                        <?=$ytb_link_name[$key]?>
                        <iframe class='video_iframe' src="https://www.youtube.com/embed/<?=$value?>"></iframe>
                    </p>
                <?php endforeach; ?>
            <?php endif; ?>
            ...
            <?php if ($ytb_link_num != 0): ?>
                <?php foreach ($ytb_link as $key => $value): ?>
                    <p style="background:rgba(255,255,255,0.01);" class='user_text'>
                        <?=$ytb_link_name[$key]?>
                        <iframe allowfullscreen="" frameborder="0"  width="100%" height="350" src="https://www.youtube.com/embed/<?=$value?>"></iframe>
                    </p>
                    <p>&nbsp;</p>
                <?php endforeach; ?>
            <?php endif; ?>
