...
<div data-role="page" class="type-interior ui-page ui-body-c ui-page-active" id="page1">
  ...
  <table id='share_btn_table'>
    <tr>
      ...
      <td>
        <a href="javascript: void(window.open('https://line.naver.jp/R/msg/text/?'+encodeURIComponent(document.title)+' - '+encodeURIComponent(location.href) ));" rel="nofollow"><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
      </td>
      <td>
        <!-- Email -->
