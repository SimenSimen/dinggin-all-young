...
<form method="post"  >
  ...
  <div class="config-div">
    <fieldset class="config-border">
        <legend class="config-border" style="width:160px">通知信設定</legend>
        ...
        <table id="member_list" class="table table-bordered table-condensed">
            ...
            <? foreach ($dbdata as $value):?>
              <tr>
                ...
                <td class='member_list_input_td'>
                  <input type="text" class="form-control" name="mail[<?=$value['d_id']?>]" value='<?=$value['d_val']?>'/>
                </td>
              </tr>
            <? endforeach;?>
          ...
          <tr>
            <td colspan="4" style="text-align:right;">
              <input type="hidden" name="d_id" id="by_id" value="<?=$dbdata['by_id']?>">
