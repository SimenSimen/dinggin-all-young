        ...
        <table id="member_list" class="table table-bordered table-condensed">
            <? //if($dbdata['prd_id']!=''):?>
              <tr>
                ...
                <td class="member_list_input_td">
                  <select name='prd_active'  style="width: 66%;" disabled>
            ...
            <tr>
              <? if (!$_SESSION['provider']) { ?>
                ...
                <td class="member_list_input_td">
                  <select name='supplier_id'  style="width: 66%;" disabled>
            ...
            <tr>
              ...
              <td class='member_list_input_td'>
                <select name="prd_cid" id="prd_cid" disabled>
                ...
                <div id='p_sub_cid'>
					       <?if (!empty($dbdata['prd_sub_cid'])){?>
        					<select name="prd_cid" id="prd_sub_cid" disabled>
              ...
              <td class='member_list_input_td'>
                ...
                <? if($dbdata['prd_image']!=''){
                      ...
                      foreach($image as $val_img){?>
                        <!-- <div class="prdSort"> -->
                          <a href="<?=$this->Spath;?><?=$val_img?>"><?=$val_img?></a><br>
            ...
            <tr>
                ...
                <td class='member_list_input_td'>
                  <textarea name='prd_content' id='ckeditor'><?=$dbdata['prd_content']?></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td class='member_list_title_td'>商品特點<br></td>
            ...
            <tr>
              <td class='member_list_title_td'>介紹影片<br></td>
              <td class='table-cell-left' style="vertical-align: top;">
          ...
          <tr>
            <td class='member_list_title_td'>商品規格<br></td>
            <td class='table-cell-left' style="vertical-align: top;">
