        ...
        <?php foreach ($dbdata as $key => $value): ?>
          <tr bgcolor='<?=$member_auth_color[$key]?>'>
            ...
            <td class='center_td white_td'> 
              <!-- <a href="javascript:void(0);" onclick="top.frames['content-frame'].location='/member/ebhinfo/<?=$value['m_id']?>/<?=$value['b_id']?>'"> -->
              <a href="javascript:void(0);" onclick="openwindow('/member/ebhinfo/<?=$value['m_id']?>/<?=$value['b_id']?>', 'Yahoo',500,500)">
