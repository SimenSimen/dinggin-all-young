...
<body scroll="yes" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center; overflow-x: hidden;overflow: -moz-scrollbars-vertical;">
  <div>
    <!--新增推播訊息form-->
    <form action='/member/edit/<?=$push['d_id']?>' method='post' name='form_push_msg_add' id='form_push_msg_add' enctype="multipart/form-data">
      <h3 style="font-family: 'Microsoft JhengHei';">編輯一則會員電子報</h3>
        <table class='table push_msg_add_table' id='push_msg_add_table' style="width:90%;">


            <input type='hidden' name='broadcasting' id='broadcasting_self' value='1'>
              <tr id="multiselect">
          ...
          <tr>
            ...
            <td class='table-cell-left'><input type='text' class='form-control required' name='title' id='title' maxlength="30" placeholder='標題文字 (30)' value="<?=$push['d_title']?>"></td>
          </tr>

          <tr>
            <td class='table-cell-right'><span class='red_star'>*</span>訊息</td>
            <td class='table-cell-left'>
              <textarea id="messagebox" name="message" class='form-control required' id='messagebox'><?=$push['d_message']?></textarea>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class='table-cell-left'>
              <input type="radio" name="status" id='status_1' value="1" <?php if($push['d_status'] == 1): ?>checked<?php endif; ?>>
              <label style="font-family: 微軟正黑體; font-weight: normal;" for='status_1'>發送</label> &nbsp;&nbsp;
              <input type="radio" name="status" id='status_2' value="2" <?php if($push['d_status'] == 2): ?>checked<?php endif; ?>>
