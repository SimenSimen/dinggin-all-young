...
<body scroll="yes" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center; overflow-x: hidden;overflow: -moz-scrollbars-vertical;">
  ...
  <div class='uform'>
    ...
    <!--新增好友分享券form-->
      <h3 style="font-family: '微軟正黑體';">新增門市</h3>
        <table class='table enews_add_table' id='enews_add_table' style="width:90%;">
          ...
          <tr>
            ...
            <td class='table-cell-left'><input type='text' class='form-control required' id='shop_name' maxlength="255"></td>
          </tr>

          <tr>
            <td class='table-cell-right'><span class='red_star'>*</span>門市地址</td>
            <td class='table-cell-left'><input type='text' class='form-control required' id='address' maxlength="255"></td>
          </tr>
	  
          <tr>
            <td class='table-cell-center' colspan="2" style="text-align:center;">
              <button class="btn btn-default" onclick="addStore()">新增</button>
            </td>
          </tr>
        </table>
    <!--end 新增商品分類form-->
