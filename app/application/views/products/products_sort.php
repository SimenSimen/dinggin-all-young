...
<div id="container"><div class="_width">
   <p style="font-size:20px;">好物精選排序
    <a href="#" class="why">?</a>
    <div class='prompt-box'>
      <p>請拖拉您要排序的商品，然後點選「儲存」</p>
      <p>1.此處好物精選，不論「上架」、「下架」均會做顯示，故會導致好物精選總數量與顯示數量不相符。</p>
      <p>2.紅色字體為已下架。</p>
    </div>
  </p>
  <br>
  ...
  <p style="width: 100%; border-radius: 5px; margin-left: 4px; vertical-align: middle;">
    <input style="background: #CCC; color: black;" class="aa3" type="button" value="好物精選筆數 (<?=$hot_num?>)">
