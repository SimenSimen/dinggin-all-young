...
<form method="post" action="/<?=$DataName?>/data_AED" onsubmit="return check(this)">
  <div class="config-div">
    <fieldset class="config-border">
        <legend class="config-border" style="width:160px">商品供應商設定</legend>
        <table id="member_list" class="table table-bordered table-condensed">
            <tr>
              <td class='member_list_title_td'>供應商名稱</td>
              <td class='member_list_input_td'>
                <input type="text" class="form-control" name="d_name" value="<?=stripslashes($dbdata['d_name'])?>"/>
              </td>
            </tr>
          <tr>
