...
<head>
  ...
  <!-- seo -->
  <title><?=$_ChangePassword?> <?=$web_config['title']?></title>
...
<div id="container" style="min-height:400px;"><div class="w1024">
  ...
  <div id="con-L" style="width:100%; text-align:center;">
    ...
    <?echo form_open('/user/update/updp', array('id'=>'form_updp'))?>
      ...
      <br>
      <br>
      <h3><i class="fa fa-tags" style="padding: 10px; color: royalblue;">  <span style="font-family:微軟正黑體; font-size: 15.5px"><?=$PasswordFormat?></span></i></h3>
      <table border="0" cellspacing="0" cellpadding="0" class="personal-info" style="width:50%; margin:0px auto;">
        ...
        <tr>
          ...
          <td class="dd2"><?=$OriginalPassword?></td>
          <td class="dd3">
            <input class='password_text' type='password' name='old_password'>
            <a href="#" class="why">?</a><div class='prompt-box'><?=$ScanPassword?></div>
        ...
        <tr>
          <td class="dd1"><span class="star">*</span></td>
          <td class="dd2"><?=$NewPassword?></td>
          <td class="dd3">
            <input class='password_text' type='password' name='password'>
            <a href="#" class="why">?</a><div class='prompt-box'><?=$ScanNewPassword?></div>
        ...
        <tr>
          <td class="dd1"><span class="star">*</span></td>
          <td class="dd2"><?=$RepeatPassword?></td>
          <td class="dd3">
            <input class='password_text' type='password' name='check_password'>
            <a href="#" class="why">?</a><div class='prompt-box'><?=$ReScanPassword?></div>
            <br>
          </td>
        </tr>
    ...
    <div>
      <br>
      <br>
      <input class='aa3' type='submit' name='form_submit' value='<?=$SendModify?>'>&nbsp;
    </div>
