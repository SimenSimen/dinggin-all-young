                        ...
                        <div class="RRR">
                          <div class="w100">
                            ...
                            <?php if($value['prd_lock_amount'] < $value['prd_amount']): ?>
                              <?php for($min[$key]; $min[$key] < $value['prd_lock_amount']+1; $min[$key]++):?>
                                <option value='<?=$min[$key]?>' select=""><?=$min[$key]?></option>
                              <?php endfor; ?>
                            <?php else: ?>
                              <?php for($min[$key]; $min[$key] < $value['prd_amount']+1; $min[$key]++):?>
                                <option value='<?=$min[$key]?>' select=""><?=$min[$key]?></option>
                              <?php endfor; ?>
                            <?php endif;?>
      ...
      <tr>
        <td>
          ...
          <br>
              ...
              <tr><td><div style="float:left; display:block; clear:both; width:35px;"><input type="checkbox" id="somemember" value="1"></div>同會員資料</td></tr>
                <?php if ($by_id != 0): ?>
                  <!-- <tr id='history_tr'>
                    <td>
                    ...
                    <div data-role="fieldcontain">
                      ...
                      <select name='buyer_logist_way' id='buyer_logist_way' class='required'>
                          ...
                          <?php foreach ($logistics_way as $log_key => $log_value): ?>
                            <?php if($log_key < 3): ?>
                              <option value='<?=$log_value['lway_id']?>'><?=$log_value['lway_name']?></option>
                            <?php endif; ?>
                          <?php endforeach; ?>
                        </select>
                    </div>
                ...
                <tr>
                  <td>
                    <div data-role="fieldcontain">
                      <label for="buyer_receipt_code"><?=$InvoiceAddress?></label>    
                      <p><div style="float:left; display:block; clear:both; width:35px;"><input type="radio" name="someadd" id='same_address'></div>同收貨地址</p>
                      <p><div style="float:left; display:block; clear:both; width:35px;"><input type="radio" name="someadd" id='member_address'></div>同會員地址</p>
                      <input id="receipt_zip" name="receipt_zip" type="text" minlength='3' maxlength='5' placeholder='<?=$PostalCode?>'/>
                      <div data-role="controlgroup" data-type="horizontal">
                        <select name="receipt_county" id="receipt_county">
                            <option value=""><?=$SelectCounties?></option>
                            <?php foreach ($tw_county as $key => $value): ?>
                              <option value='<?=$value['county']?>'><?=$value['county']?></option>
                            <?php endforeach; ?>
                        ...
                        <input id="receipt_address" name="receipt_address" type="text" maxlength='255' placeholder='<?=$InvoiceAddress?>' />
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <div align="CENTER" id="submitDiv" data-role="fieldcontain">
                      ...
                      <button type="submit" data-theme="b" name="submit" value="submit-value" class="ui-btn-hidden" aria-disabled="false"><?=$OrderPreview?></button>
                    </div>
                  </td>
                </tr>
              </table>
