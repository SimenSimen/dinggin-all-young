	...
	<body class="bg-style">
		...
		$this -> load -> view('template/template4_headmenu2', $data); ?>
                ...
                <?php if ($facebook_show): ?>
                	<a href="javascript: void(window.open('https://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"  class="c-button" id="icon-fb" ></a>
                <?php endif; ?>
      			    <!-- line -->
                <?php if ($line_show): ?>
                      <a class="c-button" id="icon-line"  href="https://line.naver.jp/R/msg/text/?<?=$public_share_title?>%0D%0A<?=$public_share_url?>"><?=$line_name?></a>
                <?php endif; ?>
