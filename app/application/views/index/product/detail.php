    ...
    <div class="products-intro clearfix pdt-details-fix">
        <div id="owl-demo" class="owl-carousel owl-theme">
            ...
            foreach ($image as $img_val) { ?>
                <div class="item">
                    <figure class="pic"><img alt="<?= $dbdata['prd_name'] ?>" src="<?= $this->Spath; ?><?= $img_val; ?>"></figure>
                </div>
            <? } ?>
        </div>
        <div class="pd-intro">
            ...
            <div class="pd-info-box">
                ...
                <div class="form-group">
                    <label class="control-label"><?= $this->lang['p_num']; //數量
                                                    ?>:</label>
            ...
            <div class="btn-group clearfix">
                <a <? if ($this->data['web_config']['cart_spec_status'] == 1) { ?> onclick="reload()" <? } ?> href="javascript: <?= $isJoinJs; ?>" class="btn addcart" <?= $isJoin; ?>><i class="icon-shopping-cart"></i> <?= $isJoinName; //加入購物車
                                                                                                                                                                                                                ?></a>
                <a href="javascript: buynow()" class="btn buynow"><i class="icon-credit-cards"></i> <?= $this->lang['p_check']; //現在結帳
                                                                                                    ?></a>
                <a href="javascript: like_id()" id="like1" class="btn wish" <?= $isFavorite; ?>><i class="icon-like"></i>
                    <?= $isFavoriteName; ?>
                </a>
                <!--<a <? if (!empty($this->session->userdata['isapp'])) { ?>  onclick="getShareEncode3()" class="btn p_share"<? } else { ?> href="/share_link" class="btn p_share fancybox-share"<? } ?> ><i class="icon-share2"></i> <?= $this->lang['p_share']; //我要分享
                                                                                                                                                                                                                                ?></a> -->
            </div>
        </div>
    </div>
