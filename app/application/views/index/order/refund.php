<section class="content has-side">
                    <div class="title"><?=$this->lang['o_11'];//申請退貨?></div>
                    ...
                    <div class="pagination_box">
                        <a href="/order/refund_info/<?=$id;?>" class="btn simple bg2 fancybox-refund"><?=$this->lang['o_11'];//申請退貨?> <i class="icon-chevron-right"></i></a>
                    </div>                    
                    <div class="pagination_box">
