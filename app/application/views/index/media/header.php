...
<script src="https://cdn.bootcss.com/lodash.js/4.17.14/lodash.min.js"></script>
...
<title><?=$this->lang_menu['jcymall'];//芬芳美學?></title>
    <?=$main_css;?>
<script>
$(function() {
	$( document ).tooltip();
...
<body class="<?=$body_class;?>">
    ...
    <div class="wrapper <?=$wrapper_class;?>">
		...
		<?=$banner;?>
		<main class="main-content wow fadeInUp index-main-fix" data-wow-delay="0.4s">
            <div class="main-top">
            <div class="container">
                <? if(!empty($path_title)){?>
