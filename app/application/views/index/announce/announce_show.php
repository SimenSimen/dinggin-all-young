				<section class="content has-side">
					<div class="title"><?=$announce['name']?></div>
					...
					<div class="editor"><?=$announce['content']?></div>
					<div class="pagination_box">
            <a href="/gold/announce" class="btn back"><i class="icon-chevron-left" aria-hidden="true"></i> <?=$this->lang['back_list'];//回列表?></a>
          </div>
				</section>
			</div>
		</main>
