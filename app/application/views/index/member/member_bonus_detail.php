				<section class="content has-side">
					<div class="title"><?=$this->lang_menu['member_bonus'];//獎金明細?></div>
                    ...
                    <p align="right"><?=$this->lang['total'];//獎金總計?><span class="color01"><?=$this->data['web_config']['currency'];?><?=number_format($itotal)?></span></p>
