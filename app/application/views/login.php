    ...
    <form class="form-signin" name='signin_form' id='signin_form' action="/index/login" method="post">
      ...
      <p>
        <select id="lang">
          ...
          <?php if ($_SESSION['chk_lang'] != 'zh-tw'):?><option value="english" <?php if($lang == 'ENG'):?>selected<?php endif; ?>><?=$English?></option>
          <option value="indonesia" <?php if($lang == 'IND'):?>selected<?php endif; ?>><?=$Indonesia?></option><?php endif;?>
        </select>
        <script>
