			...
			<div class="row">
				<div class="col-md-6 col-lg-2 col-xl-3">
					<div class="tt-mobile-collapse">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
								<li><a href="_inni_service.php">Membership terms</a></li>
								<li><a href="_inni_privacy.php">Privacy policy</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-2 col-xl-3">
					<div class="tt-mobile-collapse">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
								<li><a href="_inni_contact.php">Customer Service</a></li>
								<li><a href="_inni_faqs.php">Common problem</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 col-xl-3">
					<div class="tt-mobile-collapse">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
								<li><a href="_inni_about.php">About AllYoung</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="tt-row">
				<div class="tt-col-left">
					<div class="tt-col-item tt-logo-col">
						<!-- logo -->
						<a class="tt-logo tt-logo-alignment" href="_inni_index-14.php">
							<img  src="images/custom/logo_taiwan.jpg" alt="">
						</a>
						<!-- /logo -->
					</div>
					<div class="tt-col-item">
						...
						<div class="tt-box-copyright">
							&copy; Allyoung 2019. All Rights Reserved
						</div>
						<!-- /copyright -->
					</div>
				</div>
...
<a href="#" class="tt-back-to-top btn_totopG" data-name="b_green" id="js-back-to-top">BACK TO TOP</a>