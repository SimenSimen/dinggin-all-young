<?php $menuData = [
    ...
    ['href' => "_inni_member_bonus_dividend.php", 'icon' => 'icon-cash', 'text' => 'Bonus Point Query', 'trans' => ''],
    ['href' => "_inni_member_dividend_fun.php", 'icon' => 'icon-analysis', 'text' => 'Shopping Bouns Inquiry', 'trans' => ''],
