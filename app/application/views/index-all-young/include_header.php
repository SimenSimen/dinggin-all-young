...
<header id="tt-header">
	...
	<nav class="panel-menu mobile-main-menu">
		<ul>
			...
			<li><a href="_inni_about.php">About AllYoung</a>
				<ul>
					<li><a href="_inni_about.php">About AllYoung article title1</a></li>
					<li><a href="_inni_about.php">About AllYoung article title2</a></li>
					<li><a href="_inni_about.php">About AllYoung article title3</a></li>
					<li><a href="_inni_about.php">About AllYoung article title4</a></li>
					<li><a href="_inni_about.php">About AllYoung article title5</a></li>
				</ul>
			</li>
			<li><a href="_inni_contact.php">Contact us</a></li>
	...
	<div class="tt-mobile-header">
		<div class="container-fluid">
			<div class="tt-header-row">
				...
				<div class="tt-mobile-parent-logo">
					<!-- mobile logo -->
		...
		<!-- <div class="container-fluid tt-top-line">
			<div class="row">
				<div class="tt-logo-container">
					...
					<a class="tt-logo tt-logo-alignment" href="index.php"><img src="images/custom/logo_taiwan.jpg" alt=""></a>
						...
						<div class="tt-desctop-menu tt-hover-03">
							...
							<nav>
								<ul>
									...
									<li class="dropdown tt-megamenu-col-01">
										<a href="_inni_activity.php">Activity page</a>
										<!-- <div class="dropdown-menu">
											<div class="row tt-col-list">
												<div class="col">
									...
									<li class="dropdown tt-megamenu-col-01">
										...
										<div class="dropdown-menu">
											<div class="row tt-col-list">
												<div class="col">
													<ul class="tt-megamenu-submenu">
														<li><a href="_inni_about.php">About AllYoung article title 1</a></li>
														<li><a href="_inni_about.php">About AllYoung article title 2</a></li>
														<li><a href="_inni_about.php">About AllYoung article title 3</a></li>
														<li><a href="_inni_about.php">About AllYoung article title 4</a></li>
														<li><a href="_inni_about.php">About AllYoung article title 5</a></li>
													</ul>
												</div>
											</div>
										</div>
									...
									<li class="dropdown megamenu">
										<a href="_inni_contact.php">Contact us</a>
										<!-- <div class="dropdown-menu">
											<div class="row">
												<div class="col-sm-9">
													<div class="row tt-col-list">
	...
	<div class="tt-stuck-nav" id="js-tt-stuck-nav">
		<div class="container">
			<div class="tt-header-row ">
				...
				<div class="tt-mobile-parent-logo pad">
					<!-- mobile logo -->
					<a class="tt-logo tt-logo-alignment" href="_inni_index-14.php"><img src="images/custom/logo_taiwan.jpg" alt=""></a>
					<!-- /mobile logo -->
				</div>
