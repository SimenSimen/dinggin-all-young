...
<form method="post" action="/order/reason_AED" >
  <div class="config-div">
    <fieldset class="config-border">
        <legend class="config-border" style="width:160px">退貨理由設定</legend>
        <table id="member_list" class="table table-bordered table-condensed">
            <tr>
              <td class='member_list_title_td'>理由名稱</td>
              <td class='member_list_input_td'>
                <input type="text" class="form-control" name="reason" value="<?=stripslashes($dbdata['reason_item'])?>"/>
              </td>
            </tr>
            <tr>
				<td colspan="4" style="text-align:right;">
				  <input type="hidden" name="r_id" value="<?=$dbdata['r_id']?>">
