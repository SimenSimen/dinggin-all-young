...
<body scroll="yes" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center; overflow-x: hidden;overflow: -moz-scrollbars-vertical;">
  ...
  <div class='uform'>
    <form action='/eform/uform_add' method='post' name='form_uform_add' id='form_uform_add'>
...
<!--bottom script-->
<script type="text/javascript" src="/js/admin/system_center/uform_add.js"></script>