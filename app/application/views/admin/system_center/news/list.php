		...
		<?php if(!empty($group)): ?>
			<?php foreach ($group as $key => $value): ?>
				<tr>
					...
					<td><?=$value['c_name']?></td>
					<td>
						<a href="/<?=$this->mode_function;?>/edit/g/<?=$value['category_id']?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
						<a class="trash_group" href="javascript:;" name="<?=$value['c_name']?>" id="<?=$value['category_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
					</td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
				...
				<?php foreach ($news as $key => $value): ?>
				    ...
				    <tr>
				    	...
				    	<td>
				    		...
				    		<a onclick="window.open('/<?=$this->mode_function;?>/enews/edit/0/<?=$value['enews_id']?>', '<?=addslashes($value['name'])?>', config='height=500,width=700');"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
							<a href="/<?=$this->mode_function;?>/enews/delete/0/<?=$value['enews_id']?>" onClick="return confirm('您確定要刪除[<?=$value['name']?>]資料嗎?')" id=""><i class="fa fa-trash-o" aria-hidden="true"></i></a>
			    		</td>
				    </tr>
				<?php endforeach; ?>
				</tbody>
