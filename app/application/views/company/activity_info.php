...
<body scroll="yes" style="overflow-x: hidden;">
    ...
    <div id="header" class="Fixed">
            <div class="header-left" ><a id="hamburger" href="#menu"></a></div>
                <div class="header-logo" onclick="var sharearea = getElementById('sharearea'); sharearea.style.display=sharearea.style.display=='none'?'':'none'"><?=$data['ufm_name']?></div>
                        ...
                        <table width="100%" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td align="center"><!-- line -->
                              <a href="https://line.naver.jp/R/msg/text/?<?=$data['ufm_name']?>%0D%0A<?=$actual_link?>" rel="nofollow" >
                                <img class='share' src="/images/share_btn/line_35x35.png" />
                              </a>
                            </td>
                            <td align="center"><!-- Email -->
                              <a href="mailto:?subject=<?=$data['ufm_name']?>&body=<?=$data['ufm_name']?><?=$TheURL?><?=$actual_link ?>">
