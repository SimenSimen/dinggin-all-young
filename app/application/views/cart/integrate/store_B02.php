...
<html lang="en" class="no-js">
  ...
  <nav class="<?=$cart_menu_button?>">
   ...
   <div id="container" > 
       ...
       <div class="status" >
        <ul class="www">
            <li><a class="aa1" href="/cart/check/<?=$cset_code?>/1"><span class="icon-cart32"></span></a></li> <!--購物明細-->
            <?php if ($user_login): ?>
              <li><a class="aa1" href="/cart/record/<?=$cset_code?>"><span class="icon-file-text-o"></span></a></li> <!--訂購紀錄-->
              <li><a class="aa1" href="/cart/user_logout/<?=$cset_code?>"><span class="icon-sign-out"></span></a></li> <!--登入 or 登出-->
            <?php else: ?>
              <li><a class="aa1" href="/cart/user_login/<?=$cset_code?>"><span class="icon-sign-in"></span></a></li>
            <?php endif; ?>
        </ul>
        <?php if($class_name): ?>
            <ul class="www">
              <li><span style="display: inline-block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 240px; cursor: default;" class="aa1">類別: <?=$class_name?></span></li>
            </ul>
        <?php endif; ?>
       </div> 
