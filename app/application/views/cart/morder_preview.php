          ...
          <div class="order_div">
            ...
            <div class="order_list">
                      ...
                      <table style="width: 100%;">
                        <tr>
                          ...
                          <td><p><?=$_Quantity?><?=$prd_num[$key]?></p>
                            <p><?=$_Subtotal?><span class='price_style'>$ <?=number_format($prd_total[$key])?></span></p></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
              ...
              <p>
                ...
                <span class="price_style">$ <?=number_format($total)?><?=$Yuan?></span>
              </p>
              </div>
            </div>
          </div>
            ...
            <?php endif; ?>
              <tr>
                <td colspan="2">
                  ...
                  <button type="button" data-theme="b" name='back' id='back' class="ui-btn-hidden" aria-disabled="false" onclick="javascript:window.location.href='/cart/check/<?=$cset_code?>/1';"><?=$ReturnModifyInformation?></button>
