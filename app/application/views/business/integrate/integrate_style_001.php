...
<body class="bg_02" scroll="yes" style="overflow-x: hidden; width:640px; padding:0px 10px;">
...
<div id="container">
  ...
  <div id="header">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><a href="javascript: void(window.open('https://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"><img src="<?=$base_url?>/images/integrate/social_fb.png" alt="facebook" width="80" height="80" border="0" longdesc="#" /></a></td>
        <td><a href="javascript: void(window.open('https://twitter.com/home/?status='.concat(encodeURIComponent(document.title)) .concat(' ') .concat(encodeURIComponent(location.href))));"><img src="<?=$base_url?>/images/integrate/social_t.png" alt="" width="80" height="80" border="0" longdesc="#" /></a></td>
        <td><a href="javascript:(function(){window.open('https://v.t.sina.com.cn/share/share.php?title='+encodeURIComponent(document.title)+'&url='+encodeURIComponent(location.href)+'&source=bookmark','_blank','width=450,height=400');})()"><img src="<?=$base_url?>/images/integrate/social_sina.png" alt="" width="80" height="80" border="0" longdesc="#" /></a></td>
        ...
        <td><a href="javascript: void(window.open('https://www.plurk.com/?qualifier=shares&status=' .concat(encodeURIComponent(location.href)) .concat(' ') .concat('&#40;') .concat(encodeURIComponent(document.title)) .concat('&#41;')));"><img src="<?=$base_url?>/images/integrate/social_pl.png" alt="" width="80" height="80" border="0" longdesc="#" /></a></td>
        <td><a href="https://line.naver.jp/R/msg/text/?<?=$iqr_name?>行動商務系統 <?=$iqr_url?>" rel="nofollow" ><img src="<?=$base_url?>/images/integrate/social_line.png" width="80" height="80" style='border:0;' /></a></td>
  ...
  <!-- con_01 : name, introduction, title_name at here -->
  <div class="con_01" style="background:rgba(255,255,255,0.01);">
    <div class="hh"><h1><?=$title_text[0]?></h1></div>
  ...
  <?php if ($ytb_link_num != 0 || !empty($quote_data['ytb_link']['value'])): ?>
	  <div class="con_02">
	  <div class="hh"><h1><?=$title_text[1]?></h1></div>
	    <?php
	      // ytb_link
  ...
  <!-- con_03: bid google map -->


  <!-- con_04: all links at here -->
  <div class="con_04">
   ...
   <?php endif; ?>
    ...
    <?php if (
      ...
      ($ecp_show || !empty($quote_data['ecoupon']['value']))): ?>
      <div class="btn_space">
    ...
    <?php if ($exfile_show || !empty($quote_data['exfile']['value'])): ?>
      <div class="btn_space">
        ...
        <a class="aa01" id='exfile_box'><?=$title_text[2]?>(點此展開)</a>

        <!-- class show-data : 可展開縮合區域 -->
        <div class="show-data" id='exfile_data'>
          <?php
            // exfile
            $this->load->view('cells/exfile');
          ?>
        <!-- end class show-data : 可展開縮合區域 -->
    ...
    <?php if ($cpn_photo_show && !empty($cpn_photo_src)): ?>
      <div class="btn_space">
        <img src="<?=$base_url?>/images/integrate/icon_04.png" width="46" height="46" border="0" />  
        <a class="aa01" id='exfile_box'><?=$title_text[3]?></a>
  ...
  </div><!-- end con_04: all links at here -->
...
<style type="text/css">
  ...
  .arrows { text-decoration: none; color: #000000; margin: 0px 10px 0px 5px; }
</style>
