  ...
  <script type="text/javascript">
    ...
    $(window).load(function(){
      ...
      $(".video_iframe").each(function(i){
        ...
        //計算縮放比例
        var w=(Math.round($(window).width() * 91 / 100))/videoW;
        var h=w;
        var pre=1;
        if(w>h){
          pre=h;
  ...
  <div data-role="content">
    ...
    <table id='share_btn_table'>
        <tr>
            ...
            <td>
                <a href="https://line.naver.jp/R/msg/text/?<?=$iqr_name?>行動商務系統 <?=$iqr_url?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line.png" class='share' style='border:0;'/></a>
            </td>
            <td>
                <!-- Email -->
