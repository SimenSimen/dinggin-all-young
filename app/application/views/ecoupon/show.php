  ...
  <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain" style="text-align:center;">
    ...
    <table id='share_btn_table' style="width: 100%;">
      <tr>
          ...
          <td>
              <a href="https://line.naver.jp/R/msg/text/?<?=$my_e_coupon['name']?>%0D%0A<?=$actual_link?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
          </td>
          <td>
              <!-- Email -->
              <a href="mailto:?subject=<?=$my_e_coupon['name']?>&body=<?=$my_e_coupon['content']?><br>ç¶²å?ï¼?br><?=$actual_link?>">
    ...
    <p style="font-size: 1.3em; font-family:'å¾®è?æ­??é«?;"><?=$my_e_coupon['name']?></p>

    <img style="width:100%;" src='<?=$base_url.substr($img_url, 2).$my_e_coupon['filename']?>'>
    
    <p style="font-size: 1.3em; font-family:'å¾®è?æ­??é«?;"><?=$my_e_coupon['content']?></p>
