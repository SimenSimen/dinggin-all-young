            ...
            <form action='/push/add' method='post' name='form_push_msg_add' id='form_push_msg_add' enctype="multipart/form-data">
                ...
                <table class='table push_msg_add_table' id='push_msg_add_table' style="width:90%;">
                    ...
                    <tr>
                        ...
                        <td class='table-cell-left'>
                            <input type='text' class='form-control required' name='title' id='title' maxlength="30" placeholder='標題文字 (30)' value="<?=$push_log['title']?>" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td class='table-cell-right'>圖片</td>
                        <td class='table-cell-left'><img src="<?=$push_log['image']?>"></td>
                    </tr>
                    <tr>
                        <td class='table-cell-right'>訊息
                            <br><small>(將不會顯示於IPhone、IPad上)</small></td>
                        <td class='table-cell-left'>
                            <?=$push_log['message']?>
                        </td>
                    </tr>
...
function return_page(page) {
    window.location.href = '/push/index/' + page;
}
</script>
