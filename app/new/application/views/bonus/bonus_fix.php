...
<body background="<?=$web_config['admin_background_image']?>" bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center">
  ...
  <!--會員資料列表-->
  <table border="0" cellpadding="0" cellspacing="0" style="width:100%; border:0px solid gray;">
    ...
    <?endif;?>
      <a href="javascript:void(0)" onclick="month_total(<?=$iYear?>,<?=$value['iMonth']?>)" target="_blank" class="MonthBox">
        第<?=$value['iMonth']?>工作月
      </a>
    <? endforeach;?>
  </table>
...
function month_total(year,month){
  post_to_url('/bonus/bonus_fix_list','', {'year':year,'month':month});
}
</script>