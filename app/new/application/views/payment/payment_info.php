...
<form method="post" action="/<?=$dbname?>/data_AED" >
  ...
  <div class="config-div">
    <fieldset class="config-border">
        <legend class="config-border" style="width:160px">金流總覽</legend>
      ...
      <!--       <tr>
            ...
            <tr>
                <td class='member_list_title_td'>金流名稱 </td>
                <td class='member_list_input_td'>
                  <input type="text" class="form-control" name="pway_name" value='<?=$dbdata['pway_name']?>'/>
                </td>
            </tr>
       <!--      <tr>
            ...
            <tr>
                <td class='member_list_title_td'>金流費用</td>
                <td class='member_list_input_td'>
          ...
          <tr>
            <td colspan="4" style="text-align:right;">
              <input type="hidden" name="d_id" value="<?=$dbdata['pway_id']?>">
              <input type="hidden" name="dbname" value="payment_way">
