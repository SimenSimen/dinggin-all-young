...
<div class="wrapper">
   <section class="about-i-nav">
        <a class="i-button" id="icon-i-ebh" target="_blank" href="http://www.ebhinfo.com/index.php?lang=TW"><b>EBH</b><?=$this->lang['ebhnet'];//健康網?></a>
        ...
        <a class="i-button" id="icon-me"  href="/gold/index/<?=$aid?>/1"><?=$this->lang['about'];//關於eoneda?></a>
...
function userappcall(val){
		location.href = "/gold/index/0918666375/app";        
}
</script>
<div id="menu">
  <ul class="menu-nav">
      <li><a href="/business/iqr/0918666375" ><i></i>關於我</a></li>
      <li><a href="/gold/index/0918666375" class="now"><i></i>關於eoneda</a></li>
  </ul>
</div>                     
</div><!--/wrapper-->
</body>
