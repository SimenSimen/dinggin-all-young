		...
		<div id="page">
                 ...
                 <div class="wrapper">
                        ...
                        <section class="about-box">
                            <div class="about-me"> 
                               ...
                               <h1 class="_TitleText"><?=$iqr_name?></h1><p class="_TitleText">關於我</p>
                            </div> 
			...
			<?php $this -> load -> view('template/template3_lip', $data); ?>
                          ...
                          <section class="team-box"> 
                               <h1 class="_TitleText">團隊情報<i><img src="<?=$base_url?>template/temp3/images/team-icon.png" align="center"></i></h1>
                               <p class="line"></p>
                               <div class="index-nav-menu">
                                 <ul> 
