  ...
  <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain" style="text-align:center;">
    ...
    <table id='share_btn_table' style="width: 100%;">
      <tr>
          ...
          <td>
              <a href="http://line.naver.jp/R/msg/text/?<?=$my_e_banner['name']?>%0D%0A<?=$actual_link?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
          </td>
          <td>
              <!-- Email -->
