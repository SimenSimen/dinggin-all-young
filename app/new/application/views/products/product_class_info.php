...
<form method="post" action="/<?=$DataName?>/data_AED" >
    ...
    <fieldset class="config-border">
        ...
        <table id="member_list" class="table table-bordered table-condensed">
              ...
              <td class='member_list_input_td'>
                <select name="PID" id="PID">
                  ...
                  <?foreach ($protype as $pvalue):?>
                    <option value="<?=$pvalue['prd_cid']?>" <?=($dbdata['PID']==$pvalue['prd_cid'])?'selected':'';?>><?=$pvalue['prd_cname']?></option>  
                  <? endforeach;?>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td class='member_list_input_td'>
                <input type="text" class="form-control" name="prd_cname" value='<?=$dbdata['prd_cname']?>'/>
              </td>
            </tr>
        </table>
          <tr>
