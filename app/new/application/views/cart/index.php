...
<div id="container"><div class="w1024">
  ...
  <p style="font-size:20px;"><?=$CartProductManagement?>
    <a href="#" class="why">?</a>
    <a href='/cart/store/<?=$setting['cset_code']?>' target='_blank' class="aa5" style="font-size:20px; margin-left: 0px; padding: 9px 10px;"><?=$GoShtoppingCart?> <i class="fa fa-external-link"></i></a>&nbsp;
      ...
      <td style="word-break:break-all; width: 20%;" valign="top">
        ...
        <div style="overflow: hidden;">
          ...
          <div style="overflow: scroll; overflow-x:hidden; height: 500px; width: 228px;">
            ...
            <a href="/cart/product_hot_sort" class="link aa5"><?=$HotProudectsSort?> <i class="fa fa-bars"></i></a>
              <hr>
            <?php endif; ?>
            <!--商品分類清單-->
            <?php if ($allow_add == 1): ?>
