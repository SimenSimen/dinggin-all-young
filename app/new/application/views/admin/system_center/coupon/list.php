			...
			<table id='list' class='table table-hover table-bordered table-condensed' style="width:80%;">
				...
				<?php foreach ($coupon as $key => $value): ?>
				    <tr>
				    	...
				    	<td><?=$value['name']?></td>
				    	<td>
				    		<a onclick="window.open('/coupon/my_ecoupon/<?=$value['member_id']?>/<?=$value['ecp_id']?>', '<?=$value['name']?>', config='height=500,width=700');"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
				    		<!-- <a onclick="window.open('/coupon/ecoupon_qrcode/<?=$value['ecp_id']?>', '<?=$value['name']?>', config='height=600,width=400');"><i class="fa fa-qrcode"></i></a> -->
				    		<a onclick="window.open('/coupon/ecoupon/edit/0/<?=$value['ecp_id']?>', '<?=$value['name']?>', config='height=500,width=700');"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
