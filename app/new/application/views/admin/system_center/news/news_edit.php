      ...
      <h3 style="font-family: '微軟正黑體';"><?=$TellFriendVoucher?></h3>
        <table class='table enews_edit_table' id='enews_edit_table' style="width:90%;">
          ...
          <tr>
            ...
            <td class='table-cell-left'><input type='text' value='<?=$edit_enews['name']?>' class='form-control required' name='name' id='name' maxlength="32" placeholder='<?=$Must32Char?>'></td>
          </tr>
          ...
          <tr>
            ...
            <td class='table-cell-left'>
              <textarea name='content' class='form-control' id='content'><?=$edit_enews['content']?></textarea>
            </td>
          </tr>
          <tr>
