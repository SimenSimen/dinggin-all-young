			...
			<table id='list' class='table table-hover table-bordered table-condensed' style="width:80%;">
				...
				<?php foreach ($banner as $key => $value): ?>
				    ...
				    <tr>
				    	...
				    	<td><?=$value['name']?></td>
				    	<td>
				    		<a onclick="window.open('/banner/my_ebanner/<?=$value['member_id']?>/<?=$value['ebanner_id']?>', '<?=$value['name']?>', config='height=500,width=700');"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
				    		<a onclick="window.open('/banner/ebanner/edit/0/<?=$value['ebanner_id']?>', '<?=$value['name']?>', config='height=500,width=700');"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
							<a href="/banner/ebanner/delete/0/<?=$value['ebanner_id']?>" id=""><i class="fa fa-trash-o" aria-hidden="true"></i></a>
			    		</td>
				    </tr>
				<?php endforeach; ?>
				</tbody>
