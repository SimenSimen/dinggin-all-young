				<section class="content has-side">
					...
					<div class="editor">
						<figure class="pic"><img src="/uploads/000/000/0000/0000000000/news/<?=$news['filename']?>" alt=""></figure>
						<br>
						<?=nl2br($news['content'])?>
					</div>

                    <div class="pagination_box">
                    <a href="/gold/news/C/news/<?=$category_id?>" class="btn back"><i class="icon-chevron-left" aria-hidden="true"></i> 回列表</a>
                    </div>
                    </div>
				</section>
			</div>
