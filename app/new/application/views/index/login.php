					...
					<div class="form-box">
							<div class="form-group w130">
	                            <div class="control-box">
	                                ...
	                                <input class="form-control" type="text" placeholder="" name="d_account" value="<?=$account?>">
	                            </div>
	                        </div>
	                        <div class="form-group w130">
	                            <div class="control-box">
	                            ...
	                            <label class="control-label"><?=$this->lang['password'];//密碼?></label>
	                                <input class="form-control" type="password" placeholder="<?=$this->lang['worderror'];//文字長度不超過16字元?>" name="password" value="<?=$password?>" maxlength="16">
	                            </div>
	                        </div>
	                        <div class="form-group checbox">
	                    		<input type="checkbox" name="remember" value="1" <?=(empty($remember))?'':'checked';?>></label>
