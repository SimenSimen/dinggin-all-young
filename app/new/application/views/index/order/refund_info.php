...
<div class="lightbox-wrapper">
    ...
    提醒您，提交退貨申請，我們將於次日起1個工作天內審核，通過審核後即以E-mail回覆通知
        ...
        <input type="hidden" name="back_name" id="back_name" value="<?=$name?>">
