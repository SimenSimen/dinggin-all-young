<section class="content has-side">
    <form action="/order/member_sale" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="search_form">
		<div class="title"><?=$this->lang['member_sale'];//個人訂單查詢?></div>
		<div class="select-bar clearfix">
            ...
            <label class="control-label"><?=$this->lang['ordinter'];//訂單區間?></label>
                <div class="control-box datepicker">
                    <input class="form-control date-object" type="text" name="datepickerStart" id="datepickerStart" placeholder="">
                    <input class="form-control date-object" type="text" name="datepickerEnd" id="datepickerEnd" placeholder="">
                </div>
            </div>
            <input type="hidden" name="ToPage" id="ToPage" value="<?=$ToPage?>">
            <input type='submit' class="btn more-search2" id="search" value="<?=$this->lang['search'];//搜尋?>">
	   </div>
    </form>
					<table class="table table-h order-table refund-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-title="訂單編號："><a href="/order/member_sale_detail/<?=$value['id']?>" class="num-link"><?=$value['order_id']?></a></td>
                                ...
                                <td><a href="/order/member_sale_detail/<?=$value['id']?>" class="btn more"><i class="icon-search"></i> <?=$this->lang['detail'];//詳細資訊?></a></td>
                            </tr>
                            <? } ?>
                        </tbody>
                    </table>                    
