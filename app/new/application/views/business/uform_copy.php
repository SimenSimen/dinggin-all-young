...
<head>
  ...
  <!-- seo -->
  <title><?=$_CopyUpForm?> <?=$web_config['title']?></title>
...
<body scroll="yes" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center; overflow-x: hidden;overflow: -moz-scrollbars-vertical;">
  ...
  <div class='uform'>
    <form action='/business/uform_copy/<?=$uform['ufm_id']?>' method='post' name='form_uform_edit' id='form_uform_edit'>
    <h3 style="font-family: '微軟正黑體';"><?=$CopyUpForm?></h3>
    <h5 style="font-family: '微軟正黑體';">※&nbsp;<?=$FillActivityEx?></h5>
      <table class='table' id='uform_table'>
        ...
        <tr>
          ...
          <td><textarea class='' name="ufm_aim" id="ufm_aim"><?=$uform['ufm_aim']?></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class='table-cell-center' colspan="2">
            <input type='submit' class='btn btn-default' name='form_submit' style="font-size: 18px;" value='複製'>
