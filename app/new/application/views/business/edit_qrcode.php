...
<head>
  ...
  <!-- seo -->
  <title><?=$QRcodeStyle?> <?=$web_config['title']?></title>
...
<div id="container"><div class="w1024">
  ...
  <p style="font-size:20px;"><?=$qrcode_file_name?>&nbsp;
    <a href="#" class="why">?</a><a href='#' onclick='javascript:window.open("<?=$base_url?>business/edit_qrc_style_teach", "QR code <?=$EditUIEx?>", config="height=568,width=1054,top=50,left=143");' style="font-size:20px; margin-left: 0px;" class='aa5'><?=$EditUIEx?></a>
