                                ...
                                <td>
                                    <table width="100%" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="center">
                                                <!-- weibo -->
                                                <a href="javascript:(function(){window.open('http://v.t.sina.com.cn/share/share.php?title=<?=$film[" str_name "]?>&url=<?=$share_link?>&source=bookmark','_blank','width=450,height=400');})()"> <img src="/images/share_btn/weibo_35x35.png" name="weibo" class='share' id='weibo' title="<?=$ShareWebio?>" /></a>
                                            </td>
                                            <td align="center">
                                                <!-- googleplus -->
                                            ...
                                            <td align="center">
                                                <!-- plurk -->
                                                <a href="javascript: void(window.open('http://www.plurk.com/?qualifier=shares&status=<?=$share_link?>' .concat(' ') .concat('&#40;') <?=$film[" str_name "]?> .concat('&#41;')));"><img class='share' id='plurk' title="<?=$SharePlurk?>" src="/images/share_btn/plurk_35x35.png" /></a>
                                            </td>
                                            <td align="center">
                                                <!-- twitter -->
                                                <a href="javascript: void(window.open('http://twitter.com/home/?status=<?=$film['str_name']?>' .concat(' ') <?=$share_link?>));"><img class='share' id='twitter' title="<?=$ShareTwitter?>" src="/images/share_btn/twitter_35x35.png" /></a>
                                            </td>
                                            <td align="center">
                                                <!-- line -->
