		  ...
		  <tr>
		      <td>
		          ...
		          <a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));">
		              <img class='share' id='fb' title="<?=$ShareOnFacebook?>" src="<?=$base_url?>/images/share_btn/facebook.png" />
		          </a>
		      </td>
		      <td>
		          <!-- weibo -->
		          <a href="javascript:(function(){window.open('http://v.t.sina.com.cn/share/share.php?title='+encodeURIComponent(document.title)+'&url='+encodeURIComponent(location.href)+'&source=bookmark','_blank','width=450,height=400');})()">
		              <img class='share' id='weibo' title="<?=$ShareOnWeibo?>" src="<?=$base_url?>/images/share_btn/weibo.png" />
		          </a>
		      </td>
		      <td>
		          <!-- googleplus -->
		          <a href="javascript: void(window.open('https://plus.google.com/share?url='.concat(encodeURIComponent(location.href)), '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'));">
		              <img class='share' id='google' title="<?=$ShareOnGoogle?>" src="<?=$base_url?>/images/share_btn/googleplus.png" />
		          </a>
		      </td>
		      <td>
		          <!-- plurk -->
		          <a href="javascript: void(window.open('http://www.plurk.com/?qualifier=shares&status=' .concat(encodeURIComponent(location.href)) .concat(' ') .concat('&#40;') .concat(encodeURIComponent(document.title)) .concat('&#41;')));">
		              <img class='share' id='plurk' title="<?=$ShareOnPlurk?>" src="<?=$base_url?>/images/share_btn/plurk.png" />
		          </a>
		      </td>
		      <td>
		          <!-- twitter -->
		          <a href="javascript: void(window.open('http://twitter.com/home/?status='.concat(encodeURIComponent(document.title)) .concat(' ') .concat(encodeURIComponent(location.href))));">
		              <img class='share' id='twitter' title="<?=$ShareOnTwitter?>" src="<?=$base_url?>/images/share_btn/twitter.png" />
		          </a>
		      </td>
		      <td>
		          <a href="http://line.naver.jp/R/msg/text/?<?=$uform['ufm_name']?>%0D%0A<?=$actual_link?>" rel="nofollow" ><img src="<?=$base_url?>/images/share_btn/line.png" class='share' style='border:0;'/></a>
		      </td>
		      <td>
		          <!-- Email -->
		          <a href="mailto:?subject=<?=$uform['ufm_name']?>&body=<?=$uform['ufm_name']?><?=$URL?><br><?=$actual_link?>">
		              <img class='share' id='email' title="<?=$EmailTellFriend?>" src="<?=$base_url?>/images/share_btn/email.png" />
		          </a>
		      </td>
		  </tr>
		</table>
			...
			<?php endif; ?>
		  	...
		  	<div align="CENTER" id="submitDiv" data-role="fieldcontain">
				...
				<input type='hidden' name='ufm_col_num' value='<?=$uform['ufm_col_num']?>'>
		  		...
		  		<button type="submit" data-theme="b" name="submit" value="submit-value" class="ui-btn-hidden" aria-disabled="false"><?=$Send?></button>
		    </div>
	    </form>
