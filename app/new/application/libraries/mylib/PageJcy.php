...
class PageJcy extends MY_Controller {
	...
	function PageStar($sql,$ToPage="",$Cond="",$WhereType,$STotal=''){
		...
		//語言包
		$this->lang=$this->config('1',$this->setlang);
		$PageBox=array();
		if($ToPage==""){
		...
		$PageBox["nototal"]=($PageBox["TotalRecord"]==0)?$this->lang['nodata']:'';
		return $PageBox;
	}
	//每頁幾筆
