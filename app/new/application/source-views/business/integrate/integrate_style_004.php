    ...
    <div id="tabs">
      ...
      <?php endif; ?>
    	...
    	<div id="tabs-3">
			...
			<a class="aa05" id="so01" target="_self" onclick="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"></a>
			<a class="aa05" id="so02" target="_self" onclick="javascript: void(window.open('http://twitter.com/home/?status='.concat(encodeURIComponent(document.title)) .concat(' ') .concat(encodeURIComponent(location.href))));"></a>
			...
			<a class="aa05" id="so04" target="_self" onclick="javascript:window.location.href='http://line.naver.jp/R/msg/text/?<?=$iqr_name?>行動商務系統 <?=$iqr_url?>'" rel="nofollow"></a>
			<a class="aa05" id="so05" target="_self" onclick="javascript:(function(){window.open('http://v.t.sina.com.cn/share/share.php?title='+encodeURIComponent(document.title)+'&url='+encodeURIComponent(location.href)+'&source=bookmark','_blank','width=450,height=400');})()"></a>
			<a class="aa05" id="so06" target="_self" onclick="javascript: void(window.open('http://www.plurk.com/?qualifier=shares&status=' .concat(encodeURIComponent(location.href)) .concat(' ') .concat('&#40;') .concat(encodeURIComponent(document.title)) .concat('&#41;')));"></a>
