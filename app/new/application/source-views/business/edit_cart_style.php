...
<head>
  ...
  <!-- seo -->
  <title>行動商店設定 - <?=$web_config['title']?></title>
...
<div id="container"><div class="w1024">
  <h1 style="font-size:1.09em;">請選擇您喜歡的行動商店版型：點擊風格名稱右方連結可前往預覽視窗</h1>
  <h1>&nbsp;</h1>
          ...
          <?php foreach ($theme as $key => $value): ?>
            <li class="ui-state-default">
              ...
              <span class='theme_display_name'><?=$value['cart_display_name']?></span>
                <a onclick='pop_theme_preview("<?=$base_url.$value['cart_preview_link']?>", "<?=$value['cart_display_name']?>");' class='theme_preview aa5' style='margin-left: 4px; padding:7px 10px;' title='點此預覽'>預覽</a>
    ...
    <div class="menu_selection" style="display:none;">
        ...
        <ul id="iqr_menu_ul">
          ...
          <?php endforeach;?>
              ...
              <option value='demo-6' <?=$jqm_button_selected['demo-5']?>>灰色</option>
              </select>
          </ul>
    </div>
    <!-- <div class="step-style-1">
