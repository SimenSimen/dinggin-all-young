...
<head>
  ...
  <!-- seo -->
  <title>編輯自訂網頁 - <?=$web_config['title']?></title>
...
<body scroll="yes" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="text-align: center; overflow-x: hidden;overflow: -moz-scrollbars-vertical;">
  ...
  <div>
    ...
    <form action='/business/iqr_html_edit' method='post' name='form_iqr_html_edit' id='form_iqr_html_edit'>
      <h3 style="font-family: '微軟正黑體';">編輯自訂網頁</h3>
        <table class='table iqr_html_add_table' id='iqr_html_add_table' style="width:90%;">
          <tr>
            <td class='table-cell-right'><span class='red_star'>*</span>類別</td>
            <td>
          ...
          <tr>
            ...
            <td class='table-cell-left'><input type='text' class='form-control required' name='iqr_html_name' id='iqr_html_name' maxlength="64" value='<?=$iqr_html['html_name']?>' placeholder='最多64個字'></td>
          </tr>

          <tr>
            <td class='table-cell-right'>網頁內容</td>
