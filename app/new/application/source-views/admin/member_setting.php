  ...
  <!--會員資料列表-->
    ...
    <?php endif ;?>
      <tr>
        ...
        <td>
          <label><input type="radio" name="app_id" value="default" <?php if($member['app_id'] == 'default'): ?>checked <?php endif; ?>>&nbsp;com.appplus.BusinessCard.<?=$member['account']?></label>
          <label><input type="radio" name="app_id" value="store" <?php if($member['app_id'] == 'store'): ?>checked <?php endif; ?>>&nbsp;store.appplus.BusinessCard.<?=$member['account']?></label>
        </td>
      </tr>
    <?php if($zipBtn): ?>
      </tr>
