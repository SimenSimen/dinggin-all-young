    ...
    <center>
        <ul>
            ...
            <?php if (!empty($iqr['address'])): ?>
                <a target="_blank" onclick="location.href='http://maps.google.com.tw/maps/place/<?=$iqr['address']?>'"><img class='link' src="<?=$base_url?>template/images/about-3.png" width="75" alt="地址" /></a>
            <?php endif; ?>
