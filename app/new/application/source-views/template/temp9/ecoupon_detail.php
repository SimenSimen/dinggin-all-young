    ...
    function gobarcodeurl(){
		location ='<?=$public_barcodeurl?>';
                        ...
                        <div class="bzm-content">   
                            <ul class="share-box">
                              <li><a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"><i><img src="images/icon-fb.png" align="center" ></i>facebook</a></li>
                              <li><a href="http://line.naver.jp/R/msg/text/?<?=$public_share_title?>%0D%0A<?=$public_share_url?>"><i><img src="images/icon-line.png" align="center" ></i>LINE</a></li>
