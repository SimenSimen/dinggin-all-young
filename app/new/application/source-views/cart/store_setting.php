...
<div id="container"><div class="w1024">
  ...
  <!--主介面區-->
  <table style="width:1024px" id="cart_table">
    <tr>
          ...
          <!--<div style="overflow: hidden; height: 700px;">-->
            ...
            <div class='content_list' id='content_list' style="margin: 5px 0px 0px 0px;font-size:.7rem">
              ...
              <div class="store_setting">
                <table id='store_setting_table' class="personal-info" style="width: 105%;">
                      ...
                      <tr>
                        ...
                        <td style="width: 17%;">
                          <?php if ($custome_account[$key] == 1 && $key != 4): ?>
                           <input type='button' value='<?=$Save?>' class="aa6 business_account" id='change_business_account_button_<?=$value['iqrt_id']?>' style="margin: 0px 0px; font-size: .8rem; padding: 6px 14px;"><br> <span id='business_account_edit_info_<?=$value['iqrt_id']?>'></span>
                          <? endif ?>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                ...
                <table id='logistics_info_table' class="personal-info" style="width: 100%;">
                  ...
                  <?php foreach ($iqr_logistics as $log_key => $log_value): ?>
                    <tr>
                      ...
                      <td style="width: 17%;"><?php if ($lway_account[$log_key] == 1): ?><input type='button' value='<?=$Save?>' class="aa6 lway_account" id='change_lway_account_button_<?=$log_value['iqrt_id']?>' style="margin: 0px 0px; font-size: .8rem; padding: 6px 14px;"><br> <span id='lway_account_edit_info_<?=$log_value['iqrt_id']?>'></span><? endif ?></td>
                    </tr>
                  <?php endforeach; ?>
                  </tr>
                </table>
