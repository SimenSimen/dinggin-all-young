                    ...
                    <input type="hidden" id="price<?=$key?>" value="<?=$value['prd_price00']?>">
                      <td class="prd_name_td">
                        <a href="/cart/product_info/<?=$cset_code?>/<?=$value['prd_id']?>" target='_blank'>
                          <div class="prd_img_div"><img class="prd_img" src="<?=$img_url?>products/set_<?=substr($value['prd_image'],1)?>"></div>
                ...
                <?php if ($by_id != 0): ?><div style='float:right;color: #aaaaaa;'><h3><?=$SignIn_2?><?=$buyer['by_email']?></div></h3><?php endif; ?>
                  ...
                  <table id='buyer_table'>
                    ...
                    <tr>
                      ...
                      <td style="text-align:left;font-size:0.8em;"><?=$MailFillInCorrect?><?php if($by_id == 0):?><?=$MailThereafterLogin?><?php endif;?><br><input type="text" name='buyer_email_r' id='buyer_email' class="required email" maxlength='255'></td>
                    </tr>
                          ...
                          <select name='buyer_logist_way' id='buyer_logist_way' class="required">
                            ...
                            <?php foreach ($iqr_logistics as $log_key => $log_value): ?>
                              <?php if($log_value['lway_id'] != 4): ?>
                                <option value='<?=$log_value['iqrt_id']?>'><?=$lway_name[$log_value['iqrt_id']]?><?php if($log_value['business_account'] != ''):?> (<?=$Shipment?> <?=$log_value['business_account']?> <?=$Yuan?>)<?php endif; ?></option>
                              <?php endif; ?>
                            <?php endforeach; ?>
                          </select>
                        </p>
                    ...
                    <tr>
                      ...
                      <td style="text-align:left;">
                        ...
                        <input type="checkbox" id='same_address'><?=$SameAddress?>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
