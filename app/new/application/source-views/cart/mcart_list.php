          ...
          <div class="order_div">
            ...
            <div class="order_list" >
              ...
              <?php foreach ($prd as $key => $value): ?>   
                      ...
                      <div class="buyList-L"><a href="/cart/product_info/<?=$cset_code?>/<?=$value['prd_id']?>"><img class="prd_img" src="<?=$img_url?>products/<?=$value['prd_image']?>"></a></div>
                      <div class="buyList-R">
                  ...
                  <td>
                    <div data-role="fieldcontain">
                      ...
                      <select name='buyer_pay_way' id='buyer_pay_way' class='required'>
                          <option value=''><?=$Select?></option>
                          <?php if (!empty($iqr_trans)): ?>
                          <?php foreach ($iqr_trans as $key => $value): ?>
                            <option value='<?=$value['iqrt_id']?>'><?=$pway_name[$value['iqrt_id']].' ('.$pway_code[$value['iqrt_id']].')'?></option>
                          <?php endforeach; ?>
                          <?php endif; ?>
                        </select>
                    </div>
                    ...
                    <div data-role="fieldcontain">
                      ...
                      <select name='buyer_logist_way' id='buyer_logist_way' class='required'>
                          ...
                          <?php foreach ($iqr_logistics as $log_key => $log_value): ?>
                            <?php if($log_key < 3): ?>
                              <option value='<?=$log_value['iqrt_id']?>'><?=$lway_name[$log_value['iqrt_id']]?></option>
                            <?php endif; ?>
                          <?php endforeach; ?>
                        </select>
                    </div>
                ...
                <tr>
                  <td>
                    <div data-role="fieldcontain">
                      ...
                      <label>
                        <input type="checkbox" name="same_address" id='same_address'><?=$SameAddress?>
                      </label>
