...
<div data-role="page" class="type-interior ui-page ui-body-c ui-page-active" id="page1">
  ...
  <table id='share_btn_table'>
    <tr>
      ...
      <td>
        <a href="http://line.naver.jp/R/msg/text/?<?=$iqr_name?>行動商務系統 <?=$iqr_url?>" rel="nofollow"><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
      </td>
      <td>
        <!-- Email -->
  ...
  <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain">
    ...
    <a href="<?=$download_href?>" rel="external" data-ajax="false" data-inline="true" class="ui-btn ui-btn-b">點我收藏 App</a>
