...
<head>
  ...
  <!-- seo -->
  <title>編輯好友分享券 - <?=$web_config['title']?></title>
    ...
    <form action='/business/ecoupon/edit/0/<?=$edit_ecp['ecp_id']?>' method='post' name='form_ecoupon_edit' id='form_ecoupon_edit' enctype="multipart/form-data" onsubmit="return chk_val()">
      <h3 style="font-family: '微軟正黑體';">好友分享券</h3>
        <table class='table ecoupon_edit_table' id='ecoupon_edit_table' style="width:90%;">
          ...
          <tr>
            <td class='table-cell-right' style="width: 17%;"><span class='red_star'>*</span>分享券名稱</td>
            <td class='table-cell-left'><input type='text' value='<?=$edit_ecp['name']?>' class='form-control required' name='name' id='name' maxlength="32" placeholder='最多32個字'></td>
          </tr>
          ...
          <tr>
            ...
            <td class='table-cell-left'>
              <input type="text" class='form-control required' placeholder='最多8個字' name='btn_name'  maxlength="8" value="<?=$edit_ecp['btn_name']?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class='table-cell-left'>
              <label style="font-weight:normal; padding: 0 5px;"><input type="radio" name="share_mode" value="1" <?php if($edit_ecp['mode'] == 1):?> checked="checked" <?php endif; ?>>APP 載點</label>
              <label style="font-weight:normal; padding: 0 5px;"><input type="radio" name="share_mode" value="2" <?php if($edit_ecp['mode'] == 2):?> checked="checked" <?php endif; ?>>自訂分享網址</label>
              <label style="font-weight:normal;"><input type="radio" name="share_mode" value="3" <?php if($edit_ecp['mode'] == 3):?> checked="checked" <?php endif; ?>>自訂分享內容</label>
            </td>
          </tr>
          ...
          <tr id="share_mode_2" >
            ...
            <td class='table-cell-left'>
              <input type='text' class='form-control' name='share_url' placeholder="分享網址(請包含 http:// )" value="<?=$edit_ecp['mode_2']?>">
            </td>
          </tr>
