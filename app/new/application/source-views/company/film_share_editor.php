  ...
  <div data-role="page" class="type-interior ui-page ui-body-c ui-page-active" id="page1">
    ...
    <table id='share_btn_table'>
      <tr>
        ...
        <td>
          <a href="http://line.naver.jp/R/msg/text/?<?=$title?> <?=$iqr_url?>" rel="nofollow"><img src="<?=$base_url?>/images/share_btn/line_35x35.png" class='share' style='border:0;'/></a>
        </td>
        <td align="center">
        ...
        <td>
          <!-- Email -->
          <a href="mailto:?subject=<?=$title?> &body=我的行動商務系統網址：<br><?=$iqr_url?>">
    ...
    <div role="main" class="ui-content jqm-content" data-theme="d" id="contentMain" name="contentMain" style="text-shadow:none;">
      <iframe src="https://www.youtube.com/embed/<?=$ytb_str?>" frameborder="0" allowfullscreen></iframe>
    </div>
    
    
      <!-- <a href="<?=$download_href?>" rel="external" data-ajax="false" data-inline="true" class="ui-btn ui-btn-b"></a> -->
