...
class Banner extends MY_Controller
{
	...
	public function form_del()
	{
		...
		if(is_array($ck_array) && is_array($del_array))
		{
			...
			{
				$banner = $this -> mod_banner -> inner_join('ebanner', 'member', array('ebanner.filename', 'member.img_url'), array('ebanner_id' => $value), 'member_id', 'row');
				unlink('.' . $ebanner['img_url'] .DIRECTORY_SEPARATOR. 'banner' .DIRECTORY_SEPARATOR. $ebanner['filename']);
